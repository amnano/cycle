    ...
    <SectionContainer>
      ...
      <article>
        <div className="xl:divide-y xl:divide-neutral-200 xl:dark:divide-neutral-700">
          ...
          <div className="grid-rows-[auto_1fr] divide-y divide-neutral-200 pb-8 dark:divide-neutral-700 xl:grid xl:grid-cols-4 xl:gap-x-6 xl:divide-y-0">
            ...
            <div className="divide-y divide-neutral-200 dark:divide-neutral-700 xl:col-span-3 xl:row-span-2 xl:pb-0">
              <div className="article-content prose max-w-none pb-8 pt-10 dark:prose-invert">
                {children}
              </div>
              <div className="pb-6 pt-6 text-sm text-neutral-700 dark:text-neutral-300">
                <Link
                  href="https://www.youtube.com/@cyclepil/"
                  rel="nofollow"
                  className="text-primary-500 transition-colors duration-200 hover:text-primary-600 dark:hover:text-primary-400"
                >
                  ...
                  <div className="flex justify-between py-4 xl:block xl:space-y-8 xl:py-8">
                    {prev && prev.path && (
                      <div>
                        ...
                        <div className="text-primary-500 transition-colors duration-200 hover:text-primary-600 dark:hover:text-primary-400">
